...
export class HomeComponent implements OnInit {
  ...
  constructor(private idle: Idle, private keepalive: Keepalive,private route: Router, private toastr: ToastrService) {
    ...
    this.toastr.error('You\'ve gone idle! for too long', 'You will be logged out in ' + countdown + ' seconds!')
  ...
  simpleAlert(countdown){
    Swal.fire('You will be logged out in ' + countdown + ' seconds. Click Ok to continue using!');
  }
