...
export class TeacherService {
  ...
  postTeacher(){
    return this.http.post(environment.apiUrl + 'ClassTeacher/', this.teacherData)
  }

  putTeacher(){
    return this.http.put(environment.apiUrl + 'ClassTeacher/' + this.teacherData.classTeacherID, this.teacherData)
  }
